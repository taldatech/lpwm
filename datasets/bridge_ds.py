"""
Dataset class for the BridgeV2 Dataset
"""
...
class BridgeDataset(Dataset):
    def __init__(self, root, mode, ep_len=49, sample_length=10, image_size=128, dense=True, clips_per_video=2,
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            if self.dense:
                ...
                instruction_embedding = inst['instruction_embedding_t5'].detach()
...
class BridgeDatasetImage(Dataset):
...
if __name__ == '__main__':
    ...
    # --- episodic setting --- #
    root = '/data/bridge'
    ds = BridgeDataset(root=root, ep_len=50, sample_length=12, mode='train', image_size=128, dense=True)
