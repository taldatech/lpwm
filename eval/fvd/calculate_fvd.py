...
def calculate_fvd(videos1, videos2, device, method='styleganv', only_final=False):
    ...
    if method == 'styleganv':
        from eval.fvd.fvd.styleganv.fvd import get_fvd_feats, frechet_distance, load_i3d_pretrained
    elif method == 'videogpt':
        from eval.fvd.fvd.videogpt.fvd import load_i3d_pretrained, frechet_distance
        from eval.fvd.fvd.videogpt.fvd import get_fvd_logits as get_fvd_feats
